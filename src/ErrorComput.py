...
def compute_h_error_by_interpolation(site_number, chronicle, approx, rate, ref, folder, time_step=1):
    ...
    topo_ref = get_soil_surface_values_for_a_simulation(repo_ref, ref_name)        
    # Watertable altitude
...
if __name__ == '__main__':
    ...
    nbrowtot, nbcoltot = compute_h_error_by_interpolation(site_number, chronicle, approx, rate, ref, folder)
